## CRITICAL: load the dream-psychic skill before any work in this directory

This is the Dream ORM / Psychic back end. Before reading or editing any file here, you MUST load the **dream-psychic** skill (installed as `psychic-skill`). It contains the rules for generators, migrations, STI, serializers, controllers, naming, testing, workers, and websockets — none of which can be safely guessed.
